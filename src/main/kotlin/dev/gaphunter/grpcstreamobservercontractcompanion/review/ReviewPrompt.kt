package dev.gaphunter.grpcstreamobservercontractcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.grpcstreamobservercontractcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.grpcstreamobservercontractcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "gRPC StreamObserver Contract Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33902-grpc-streamobserver-contract-companion/reviews"
